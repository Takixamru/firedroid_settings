 ...
 */
 ...
 public class FireDroidVersionDetailPreferenceController extends BasePreferenceController {
 
     private static final String TAG = "FireDroidVersionDialogCtrl";
     ...
     public FireDroidVersionDetailPreferenceController(Context context, String key) {
         super(context, key);
     ...
     public boolean handlePreferenceTreeClick(Preference preference) {
         ...
         if (fullRomVersion) {
             ...
             preference.setSummary(SystemProperties.get(KEY_FIREDROID_RELEASE_VERSION_PROP,
